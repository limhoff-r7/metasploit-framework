...
# generic fashion.
module Metasploit::Framework::UI::Text::Shell
  require 'metasploit/framework/ui/text/shell/input_shell'
  ...
  def init_ui(in_input = nil, in_output = nil)
    ...
    if (self.input)
      ...
      if (self.input.intrinsic_shell? == false)
        self.input.extend(Metasploit::Framework::UI::Text::Shell::InputShell)
      end

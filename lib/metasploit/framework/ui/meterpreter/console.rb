...
#
###
class Metasploit::Framework::UI::Meterpreter::Console

  include Metasploit::Framework::UI::Text::DispatcherShell

  # Dispatchers
  require 'metasploit/framework/ui/meterpreter/console/interactive_channel'
  require 'metasploit/framework/ui/meterpreter/console/command_dispatcher'
  require 'metasploit/framework/ui/meterpreter/console/command_dispatcher/core'
  ...
  def interact_with_channel(channel)
    channel.extend(Metasploit::Framework::UI::Meterpreter::Console::InteractiveChannel) unless (channel.kind_of?(Metasploit::Framework::UI::Meterpreter::Console::InteractiveChannel) == true)

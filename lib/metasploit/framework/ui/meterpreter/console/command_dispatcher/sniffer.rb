...
#
###
class Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher::Sniffer
  include Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher

  Klass = Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher::Sniffer

...
###
class Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher::Mimikatz
  include Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher

  Klass = Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher::Mimikatz

...
#
###
class Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher::Extapi::Window

  Klass = Metasploit::Framework::UI::Meterpreter::Console::CommandDispatcher::Extapi::Window

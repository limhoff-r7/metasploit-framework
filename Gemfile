...
gem 'metasploit-model', git: 'git://github.com/rapid7/metasploit-model.git', tag: 'v0.21.5.exploit'
...
group :db do
  ...
  gem 'metasploit_data_models', git: 'git://github.com/rapid7/metasploit_data_models.git', :tag => 'v0.59.5.exploit'

...
describe Metasploit::Framework::UI::Console::Command::Search::Table, :ui do
  ...
  let(:parent) do
    Metasploit::Framework::UI::Console::Command::Search.new(
        dispatcher: dispatcher
    )
  end

  it_should_behave_like 'Metasploit::Framework::UI::Console::Command::Child'
  it_should_behave_like 'Metasploit::Framework::UI::Console::Command::Search::Table::Columns'
  it_should_behave_like 'Metasploit::Framework::UI::Console::Command::Search::Table::TabCompletion'
  it_should_behave_like 'Metasploit::Framework::UI::Console::Command::Search::Table::ValidationErrors'

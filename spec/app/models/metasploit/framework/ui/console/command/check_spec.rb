...
describe Metasploit::Framework::UI::Console::Command::Check, :ui do
  ...
  context 'subcommands' do
    it { should have_subcommand(:help).class_name('Metasploit::Framework::UI::Console::Command::Check::Help') }
    it { should have_subcommand(:simple).class_name('Metasploit::Framework::UI::Console::Command::Check::Simple').default(true) }
  end

shared_examples_for 'Metasploit::Framework::UI::Console::Command::Search::Table::TabCompletion' do
  ...
  context '#column_name_tab_completions' do
    ...
    shared_examples_for 'columns' do |type, last_word|
      let(:column_names) do
        Metasploit::Framework::UI::Console::Command::Search::Argument::Column.set.to_a
      end
      ...
      context "with #{last_word}" do
        ...
        context "with ##{type}_columns" do
          ...
          let(:column) do
            Metasploit::Framework::UI::Console::Command::Search::Argument::Column.new(value: column_name)
          end
